...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    void getByEmail() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL_SLASH + "by-email").param("email", ADMIN_MAIL))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(USER_MATCHER.contentJson(admin));
    }
    ...
    void createInvalid() throws Exception {
        User invalid = new User(null, null, "", "newPass", "pass", Set.of(Role.USER, Role.ADMIN));
    ...
    void updateInvalid() throws Exception {
        ...
        String string = jsonWithPassword(invalid, "invalidPass");
        perform(MockMvcRequestBuilders.put(REST_URL_SLASH + USER_ID)
                .contentType(MediaType.APPLICATION_JSON)
                .content(string))
                .andDo(print())
    ...
    void createDuplicate() throws Exception {
        User expected = new User(null, USER_MAIL, "Ivan", "Petrov",  "pass", Set.of(Role.USER, Role.ADMIN));
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
